  ...
  const generateFeedback = async () => {
    ...
    try {
      const response = await axios.post(
        ...
        {
          contents: [{ parts: [{ text: `Here is the transcribed text from a user: ${transcript}. Based on this, please provide three lines of feedback to help improve their communication skills.` }] }],
        }
      );
